...
//       {/* HEADER */}
//       <div className="absolute top-[5vh] left-1/2 transform -translate-x-1/2 z-10 px-6 tracking-tighter">
//         <p className="mt-2 text-3xl text-[#FF0000]">
//           Directed by <span className="text-[#FF0000]">Utkarsh Awasthi</span>
//         </p>
//       </div>
...
//           const gallery =
//             typeof video.gallery === 'string'
//               ? JSON.parse(video.gallery)
//               : video.gallery

//           return (
//             <div key={video.id || i} className="relative group flex flex-col items-center w-full max-w-sm">
...
//                 onClick={() =>
//                   router.push(
//                     `/gallery?title=${encodeURIComponent(video.title)}&images=${encodeURIComponent(JSON.stringify(gallery))}&credits=${encodeURIComponent(video.credits)}`
//                   )
//                 }
